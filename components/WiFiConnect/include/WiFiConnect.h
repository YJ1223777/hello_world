 ...
 * @Date: 2023-12-05 19:10:18
 * @LastEditors: error: error: git config user.name & please set dead value or install git && error: git config user.email & please set dead value or install git & please set dead value or install git
 * @LastEditTime: 2023-12-05 19:44:54
 * @FilePath: \hello_world\components\WiFiConnect\include\WiFiConnect.h
...
#define EXAMPLE_ESP_WIFI_SSID      "666666"
#define EXAMPLE_ESP_WIFI_PASS      "yjxx162389"
